...
class Application:
    ...
    def mainwindow(self):
        ...
        main.configure(width=500, height=710, bg=background)
        ...
        self.TextInput = tk.Entry(bg=chatbg, fg=foreground)
        self.TextInput.place(relwidth=0.74, relheight=0.06, rely=0.9, relx=0.02)
        self.TextInput.focus()
        self.TextInput.bind("<Return>", self.EnterPress)

        enter = tk.Button(main, text="SEND", bg=chatbg, fg=foreground, font=("Rockwell", "12", 'bold'), activebackground="")
